...
import { Database, LogOut, Shield, Users, Building } from "lucide-react";
        ...
        <Sidebar>
          <SidebarHeader>
            <div className="flex items-center gap-2 p-2">
              <AppLogo className="w-8 h-8 text-sidebar-foreground" />
              <span className="text-lg font-semibold font-headline">AsetIT KKM</span>
            </div>
          </SidebarHeader>
          <SidebarContent>
            <SidebarMenu>
              ...
              {user?.role === 'admin' ? (
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    isActive={pathname === '/dashboard/manage-data' || pathname === '/dashboard/bulk-upload' || pathname === '/dashboard/export-data'}
